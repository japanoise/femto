...
int main(int argc, char **argv)
{
	...
	start_color();
	use_default_colors();
	init_pair(ID_DEFAULT, COLOR_DEFAULT, COLOR_DEFAULT);       /* alpha */
	init_pair(ID_SYMBOL, COLOR_CYAN, COLOR_DEFAULT);           /* non alpha, non digit */
	init_pair(ID_DIGITS, COLOR_YELLOW, COLOR_DEFAULT);         /* digits */
	init_pair(ID_BLOCK_COMMENT, COLOR_GREEN, COLOR_DEFAULT);   /* block comments */
	init_pair(ID_LINE_COMMENT, COLOR_GREEN, COLOR_DEFAULT);    /* line comments */
	init_pair(ID_SINGLE_STRING, COLOR_YELLOW, COLOR_DEFAULT);  /* single quoted strings */
	init_pair(ID_DOUBLE_STRING, COLOR_YELLOW, COLOR_DEFAULT);  /* double quoted strings */
